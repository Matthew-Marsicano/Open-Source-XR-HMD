...
from luma.core.legacy.font import ATARI_FONT
import math
Gyro  = [0,0,0]
Accel = [0,0,0]
Mag   = [0,0,0]
...
def move_and_draw_stars(stars, max_depth, TEMP_DATA):
    ...
    with canvas(device) as draw:
        for star in stars:
            ...
            if 0 <= x < device.width and 10 <= y < device.height:
                ...
                text(draw,(0,0),"Temp at Head%6.2f°C"%(TEMP_DATA),fill=(255), font=ATARI_FONT)
...
def main():
    ...
    while True:
        try:
            ...
            print("\n") 
            break 
        move_and_draw_stars(stars, max_depth, TEMP_DATA)
        try:
